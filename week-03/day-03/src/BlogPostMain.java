public class BlogPostMain {
  public static void main(String[] args) {
    BlogPost blogPostObject1 = new BlogPost("John Doe", "Lorem Ipsum",
            "Lorem ipsum dolor sit amet.", "2000.05.04.");
    BlogPost blogPostObject2 = new BlogPost("Tim Urban", "Wait but why",
            "A popular long-form, stick-figure-illustrated blog about almost everything.", "2010.10.10.");
    BlogPost blogPostObject3 = new BlogPost("William Turton", "One Engineer " +
